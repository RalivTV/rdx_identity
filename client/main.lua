...
RegisterNetEvent('rdx_identity:showRegisterIdentity')
AddEventHandler('rdx_identity:showRegisterIdentity', function()
	if not isDead then
		EnableGui(true)
	end
end)

RegisterNetEvent('rdx_identity:identityCheck')
AddEventHandler('rdx_identity:identityCheck', function(identityCheck)
	hasIdentity = identityCheck
end)

RegisterNetEvent('rdx_identity:saveID')
AddEventHandler('rdx_identity:saveID', function(data)
	myIdentifiers = data
end)
...
RegisterNUICallback('escape', function(data, cb)
	if hasIdentity then
		...
		RDX.ShowNotification(_U('create_a_character'))
	end
end)
